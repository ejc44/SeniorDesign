...
public class BooleanTreeEqual {
	...
	public BooleanTreeEqual(int num_vars, int[] table, int[][] SOP, int sop_terms)
	{
	...
	public BooleanTreeEqual(int numVars, ArrayList<String> lines) {
		random_generator = new Random(System.currentTimeMillis()); // Seed random number generator
		all_nodes = new ArrayList<Node>();
	...
	public void mutate()
	{
		...
		{
			int choice = random_generator.nextInt(8); // Generate an integer to select the type of mutation
			
			// Choose type of mutation - All mutations are equally probable
